...
namespace Facebook
{
    class UserSignUp {
        ...
        //WebElements
        private IWebElement txtFirstName = GlobalDefenitions.driver.FindElement(By.Name("firstname"));
        private IWebElement txtSurName = GlobalDefenitions.driver.FindElement(By.Name("lastname"));
        private IWebElement txtEmailOrMobile = GlobalDefenitions.driver.FindElement(By.Name("reg_email__"));
        private IWebElement txtReenterEmail = GlobalDefenitions.driver.FindElement(By.Name("reg_email_confirmation__"));
